...
from report.views import  hr_report, Teamlead_report, Candidate_report,account_report , function_number_name
...
urlpatterns =[
    ...
    path('function_number_name/',function_number_name,name='function_number_name')
